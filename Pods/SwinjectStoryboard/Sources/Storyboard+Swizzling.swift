...
extension Storyboard {
    ...
    @objc
    fileprivate class func swinject_storyboardWithName(_ name: String, bundle storyboardBundleOrNil: Bundle) -> Storyboard {
        if self === Storyboard.self {
            ...
            if SwinjectStoryboard.isCreatingStoryboardReference {
                return SwinjectStoryboard.createReferenced(name, bundle: storyboardBundleOrNil)
            } else {
                return SwinjectStoryboard.create(name, bundle: storyboardBundleOrNil)
            }
        } else {
